...
- The active experimental panel must contain 30 single mutants only. Combination mutants may be proposed only after the corresponding single-mutant expression experiments have been completed and reviewed.
...
- The current 30-sequence deliverable must contain single substitutions only. Do not generate, score, recommend, or deliver double/multiple mutants in the active route until single-mutant experimental results have been reviewed.
