...
- The active final-panel contract is version V3: the 30-sequence experimental panel must contain 15 single mutants and 15 double mutants. The 15 double mutants may be formed only from the 15 selected single-mutant parents; same-position alternatives are mutually exclusive and must never be combined.
...
- The current V3 deliverable is explicitly limited to 15 approved single substitutions plus 15 double substitutions selected from the complete valid unordered pair space of those 15 parents. Do not introduce a double-mutant component outside the approved 15, do not combine two alternatives at the same reported position, and do not generate triple/higher-order mutants.
