...
- The optimization objective must preserve the experimentally observed Nb252 epitope and binding conformation. There are no additional collaborator-imposed mutation exclusions and no prior mutation-effect dataset; computational safety constraints and experimental testability still apply.
