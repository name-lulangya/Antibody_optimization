...
- The released `expression_single_mutant_selection_v3_20260825` 30-single-mutant artifact remains the immutable upstream V3 shortlist and must not be rewritten. The active parent-single expert-review and selection pool is those 30 candidates plus the user-added stable-word exploratory mutant `T99F`, for 31 candidates across 23 reported positions; the 15 parents will be selected from this 31-candidate pool. `T99F` retains its upstream `not_eligible`/`not_selected` status because it has no moderate or strong positive NetSolP U/S or NanoMelt signal, and its stable-word gain is a hypothesis for expert review rather than predictor-qualified evidence. Neither the immutable 30-row artifact nor the 31-candidate review pool is itself the final 30-sequence panel.
