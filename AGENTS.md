...
- The released `expression_single_mutant_selection_v3_20260825` 30-single-mutant artifact is the immutable upstream V3 shortlist from which the 15 parents will be selected. It is not itself the final 30-sequence panel after this contract change.
